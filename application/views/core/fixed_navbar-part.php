    ...
    <nav class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <div class="navbar-brand"><img src="<?=base_url('/media/static/logo_small.png')?>" height="40"></div>
        </div>
        <?php if ( ! isset($MODULE)){$MODULE = '';} if ( ! isset($SUBMODULE)){$SUBMODULE = '';}?>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
          <li<?php if ('HOME' == $MODULE):?> class="active"<?php endif;?>><a href="<?=site_url('/')?>">Home</a></li>
		  ...
		  <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?=$user['salutation'].' '.$user['first_name'].' '.$user['surname'].' '.$user['other_names']?>  <span class="caret"></span></a>
              <ul class="dropdown-menu">
                ...
                <li role="separator" class="divider"></li>
                <li><a href="<?=site_url('/logout/')?>"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp; Logout</a></li>
              </ul>
            </li>
          </ul>
          <?php endif; ?>
